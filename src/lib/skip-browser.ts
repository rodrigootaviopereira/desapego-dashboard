const BACKEND_URL = "https://pixel-implementation-clone-3c137.shrd00.internal.goskip.dev/backend/v1";
const POCKETBASE_URL = "https://pixel-implementation-clone-3c137.shrd00.internal.goskip.dev";
